...
Speed dating is becoming an increasingly popular form of dating. We downloaded speed dating data from experiments conducted by Raymond Fisman, et al. (2006) conducted on students at Columbia University. Students were asked to score characteristics most important to them for a future date, as well as to score each person they speed dated and finally give a yes or a no to seeing the other person again on a regular date.
...
Data is collected by survying `nrow(d)` participants of speed dating events. Informaiton is then recoded into `ncol(d)` variables.  
